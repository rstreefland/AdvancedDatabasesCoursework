...
public class Specific {
	...
	public Specific() {
		...
		setFraudTarget(FraudTarget.BLANK);
		manslaughterType = ManslaughterType.BLANK;
		manslaughterSeriousness = ManslaughterSeriousness.BLANK;
		setManslaughterLossControl(ManslaughterLossControl.BLANK);
		vehicleInvolved = VehicleInvolved.BLANK;
		substanceClassification = SubstanceClassification.BLANK;
		substanceType = SubstanceType.BLANK;
